...
def main():
    # Configure the Streamlit page before rendering the interface.
    st.set_page_config(
    ...
    # Place the three preset prompts in the order shown on the page.
    ...
    # -----------------------------
    # Run all model checks after the user submits a prompt.
    if run_button:
